...
public class Sudokufile extends javax.swing.JFrame {
    ...
    {
        JButton predefinedBtns[] = {r1c4,r1c7,r1c8,r1c9,r2c1,r2c5,r2c7,r2c9,r3c1,r3c3,r3c5,r3c7,r4c5,r4c6,r4c8,r5c2,r5c3,r5c7,r5c8,
                                     r6c2,r6c4,r6c5,r7c2,r7c5,r7c7,r7c9,r8c1,r8c4,r8c5,r8c9,r9c1,r9c2,r9c3,r9c6};//here predefinedBtns[] conatins all fixed btns in sudoko game
        
        JButton [][]btns = {
         //It is Full Suduko Grid
       ...
       for(int i=0; i<9; i++)
       {
         for(int j=0; j<9; j++)
         {
            ...
            {
                btns[i][j].setText("");
                btns[i][j].setForeground(black);//Foreground means Text Color is Black
    ...
    private void exitbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exitbtnActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(frame, "Do want to Quit the GAME", "Sudoku-Puzzle", JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION)
        {
            System.exit(0);
        }
